...
const PayMany: React.FC<PayManyProps> = ({
  ...
  const paymentOptions: PaymentOption[] = [
    ...
    },
    {
      id: 'cash_and_check',
      label:
        'مایلم بابت ودیعه خسارت مبلغ 50,000,000 تومان نقد به همراه 800,000,000 میلیون تومان چک صیادی (بنفش) پرداخت نمایم.',
    },
    {
      id: 'reservation_only',
      label: 'مایلم فقط با پرداخت مبلغ 5,150,000 تومان خودرو را رزرو نمایم.',
    },
  ];
